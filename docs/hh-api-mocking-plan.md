...
3. Искать кандидата по одному из признаков:
   ...
   - сообщение в HH: `привет я владимир кобзев <operator-email>`;
...
| 3.10 | Найти тестового кандидата по `resume_id` или сообщению `привет я владимир кобзев <operator-email>` | user + bot |
