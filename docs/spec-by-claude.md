...
Конкретизация первой итерации вынесена в [`docs/iteration-1-tz-and-test-data.md`](iteration-1-tz-and-test-data.md). Начинать кодинг с неё, а этот документ использовать как широкий архитектурный контекст.
