...
printf '%s\n' "export SANDBOX_SECONDARY_DEMO_EMAIL='demo-beta@hiring-agent.app'"
printf '%s\n' "export SANDBOX_SECONDARY_DEMO_PASSWORD='\$SANDBOX_DEMO_PASSWORD'"
printf '%s\n' "export SANDBOX_SECONDARY_DEMO_RECRUITER_ID='recruiter-sandbox-beta-001'"
printf '%s\n' "export SANDBOX_SECONDARY_DEMO_CLIENT_ID='client-sandbox-beta-001'"
printf '%s\n' "export SANDBOX_SECONDARY_DEMO_RECRUITER_TOKEN='rec-tok-sandbox-beta-001'"
