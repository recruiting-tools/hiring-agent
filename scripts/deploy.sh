...
DB_SECRET_ENV="${DB_SECRET_ENV:-CHATBOT_DATABASE_URL}"
...
ENV_VARS="USE_REAL_DB=true,NODE_ENV=production,HH_SEND_ENABLED=false,OUTBOUND_SEND_ENABLED=false,DEPLOY_SHA=$DEPLOY_SHA,DEPLOY_TIME=$DEPLOY_TIME,APP_ENV=$APP_ENV,EXTERNAL_MODE=$EXTERNAL_MODE,LLM_MODE=$LLM_MODE,HH_REDIRECT_URI=https://recruiter-assistant.com/hh-callback/"
