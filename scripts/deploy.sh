...
ENV_VARS="USE_REAL_DB=true,NODE_ENV=production,HH_SEND_ENABLED=false,OUTBOUND_SEND_ENABLED=false,DEPLOY_SHA=$DEPLOY_SHA,DEPLOY_TIME=$DEPLOY_TIME,APP_ENV=$APP_ENV,EXTERNAL_MODE=$EXTERNAL_MODE,LLM_MODE=$LLM_MODE,HH_REDIRECT_URI=https://candidate-chatbot.recruiter-assistant.com/hh-callback/"
